...
require (
	...
	github.com/sylabs/scs-build-client v0.9.19
	github.com/sylabs/scs-key-client v0.7.8
...
require (
	...
	github.com/moby/go-archive v0.0.0-20250404171912-21f3f3385ab7 // indirect
